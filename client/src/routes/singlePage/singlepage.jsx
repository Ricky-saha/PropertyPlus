...
function SinglePage() {
  ...
  const handleSave =async ()=>{
    ...
    try{
      await apiRequest.post("/auth/users/save",{postId : post.id})
          ...
          <div className="listVertical">
            ...
            <div className="feature">
              ...
              <div className="featureText">
                ...
                <p>{post.postDetail.income === "Required" ? "Must have 3x the rent in total household income" : "No income requirement"}</p>
              </div>
            </div>
          </div>
